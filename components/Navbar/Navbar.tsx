...
import frame from "../public/images/frame1.png";
    ...
    <div className="bg-[#F7F7F7] shadow-md">
      ...
      <div className="flex items-center justify-between px-6 py-4 md:px-10">
        ...
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl text-black font-bold font-inter">Ddsgnr</h1>
        </div>
          ...
          <ul className="flex flex-col items-start p-4 gap-4">
            ...
            <div className="w-full border-b pb-4">
              <p className="text-sm text-black">
                Phone Number: <span className="text-black font-semibold">956 742 455 678</span>
              </p>
